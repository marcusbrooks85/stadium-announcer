  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button variant="ghost" size="icon" className="h-10 w-10 text-muted-foreground hover:text-[var(--tenant-primary)] hover:bg-[var(--tenant-primary)]/10 transition-all rounded-full">
                ...
                <Link href={item.href}>
                  <div className={cn("flex items-center justify-between p-4 rounded-2xl transition-all duration-300 group", isActive ? "bg-[var(--tenant-primary)] text-white shadow-xl" : "text-muted-foreground hover:bg-white/5 hover:text-white")}>
                    <div className="flex items-center gap-4">
                      <div className={cn("p-2 rounded-lg transition-colors", isActive ? "bg-white/20" : "bg-black/20")}>
