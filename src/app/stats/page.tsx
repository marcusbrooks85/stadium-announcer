...
export default function GameStatsPage() {
  const { roster, updateStat, emailStats } = useGame();
  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col min-h-screen bg-background text-foreground stadium-gradient overflow-x-hidden">
        {/* HEADER */}
        <header className="sticky top-0 z-50 flex items-center justify-between p-4 border-b border-border shadow-2xl bg-card/95 backdrop-blur-md h-16 md:h-20">
          <div className="flex items-center gap-4">
             ...
             <h1 className="font-headline font-black uppercase tracking-[0.2em] text-sm md:text-lg hidden sm:block">Game Stats Dashboard</h1>
          </div>
          
          <div className="flex items-center gap-3">
             <Badge variant="outline" className="font-mono text-primary border-primary/30 py-1 px-3">
               LIVE TRACKING
             </Badge>
          </div>
        </header>

        <main className="flex-1 p-4 md:p-8 space-y-6 md:space-y-10 max-w-7xl mx-auto w-full pb-24">
