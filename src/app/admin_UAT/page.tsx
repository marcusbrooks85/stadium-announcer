  ...
  return (
    <div className="min-h-screen bg-background text-foreground stadium-gradient p-4 md:p-8">
      ...
      <footer className="fixed bottom-0 left-0 right-0 p-4 bg-card/90 backdrop-blur-md border-t border-white/5 flex justify-center gap-4">
        <Link href="/schedule_UAT"><Button variant="ghost" size="sm" className="font-black uppercase text-[10px]"><Calendar className="h-4 w-4 mr-2" /> UAT Schedule</Button></Link>
        <Link href="/booth_UAT"><Button variant="ghost" size="sm" className="font-black uppercase text-[10px]"><Zap className="h-4 w-4 mr-2" /> UAT Booth</Button></Link>
      </footer>
    </div>
  );
}
